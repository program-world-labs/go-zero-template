...
{{if .withCache}}{{.cacheKeys}}
cache{{.upperStartCamelObject}}CountPrefix = "cache:{{.lowerStartCamelObject}}:list:count:"
cache{{.upperStartCamelObject}}ListPrefix = "cache:{{.lowerStartCamelObject}}:list:"{{end}}
)
